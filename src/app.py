...
activities = {
    ...
    "Hiking Club - Beginner": {
        "description": "Explore beginner-friendly hiking trails and enjoy nature",
        "schedule": "Saturdays, 8:00 AM - 12:00 PM",
        "max_participants": 15,
        "participants": ["ethan@mergington.edu", "grace@mergington.edu"]
    },
    "Hiking Club - Advanced": {
        "description": "Challenge yourself with advanced hiking trails and scenic views",
        "schedule": "Sundays, 6:00 AM - 2:00 PM",
        "max_participants": 10,
